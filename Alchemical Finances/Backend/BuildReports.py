# This program is design to generate reports for Alchemical Finances and utilizes existing:
...
from Backend.UPK import obtain_sql_list, obtain_sql_value, cash_format
...
class Generate_user_report:
    def __init__(self, request):
        ...
        # ---- Program --------------------------------------------------------------------------------------------------------------------------------------------------------
        # request = [Database, User Name, Report Content, "Bank", "Primary Checking 0961", ]
        report_date = datetime.now().strftime('%Y%m%d%M')
        report_date_visual = datetime.now().strftime('%B %d, %Y')
        ...
        subtitle = "Generated by Alchemical Finances"
    ...
    def summary_report_table(self, request):
        ...
        for lst in parenttype_list:
            parent_type = lst[0]
            acc_statement = """SELECT ID, SubType, Balance FROM Account_Summary WHERE ParentType='""" + parent_type + """' ORDER BY ID, SubType, Balance DESC LIMIT 0, 49999"""
        ...
        for lst in parenttype_list:
            ...
            if len(parenttype_acc_list) == 0:
                ...
                for account in parenttype_acc_list:
                    ...
                    convert = [account[0], account[1], formatted_balance[1]]
            ...
            if header_rows[0] != 0:
                if table_data[0][1] == "Subtotal":
                    ...
                    missing_header = [
                        ...
                        ('FONTSIZE', (0, reference_row), (-1, next_ref_row - 2), 11),
...
if __name__ == "__main__":
    ...
    request_content2 = [['Bank', '', ''],
                        ...
                        ['Treasury', '', ''],
                        ['Credit', '', '']]
    user_request = [database, "Jmshamberg", request_content2, initial_dir]
    Generate_user_report(user_request)
