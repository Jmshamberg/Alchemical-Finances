...
from Backend.AccountsDialog import Accounts
from Backend.CategoriesDialog import TransactionForm
from Backend.Receipt import Receipt
from Frontend.Ledger1Ui import Ui_Dialog
from Backend.UPK import receipt_pathway, obtain_sql_value, modify_for_sql, check_characters, specific_sql_statement,\
    decimal_places, add_comma, remove_comma, disp_ledgerV1
from Frontend.StyleSheets import UniversalStyleSheet, uFrameStyleSheet, uTitleStyleSheet
...
class LedgerV1(QDialog):
    ...
    def check_transactions(self):
        if check_characters(self.widgetlist[3].text(), "general") is False:
            return False    # TM Has Non Alphanumeric characters
        elif check_characters(self.widgetlist[4].text(), "general") is False:
        ...
        elif check_characters(self.widgetlist[6].text(), "general") is False:
            return False    # Debit is a non alphanumeric character
        elif check_characters(self.widgetlist[7].text(), "general") is False:
            return False    # Credit is a non alphanumeric character
        elif check_characters(self.widgetlist[8].toPlainText(), "general") is False:
        ...
        elif self.widgetlist[6].text() == "" and self.check_numerical_inputs(self.widgetlist[7].text()):
