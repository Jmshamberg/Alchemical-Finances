...
from Frontend.Ledger2Ui import Ui_Dialog
...
from Frontend.StyleSheets import uFrameStyleSheet, uTitleStyleSheet
...
class LedgerV2(QDialog):
    ...
    def __init__(self, database, parentType, user):
        ...
        self.buttonlist[9].clicked.connect(self.update_ticker_price)                # Update the Ticker Price
    ...
    def check_transactions(self):
        ...
        listB = [5, 6, 7, 8, 13]
        for widget in listA:
            if check_characters(self.widgetlist[widget].text(), "general") is False:
        ...
        for widget in listB:
            if check_characters(self.widgetlist[widget].text(), "general") is False:
                ...
                continue
        if check_characters(self.widgetlist[9].toPlainText(), "general") is False:
              ...
              for col in range(0, 9):
                ...
                if widget == 2:
                    ...
                    if dataPoint == "":
                        ...
                        self.widgetlist[priceadjustment].setText(noCommaValue)
                elif widget == 8:
                    # col 6 = Status
