...
from Frontend.UserLoginUi import Ui_Dialog
from Backend.UPK import account_pathway, generate_key, check_characters, spacing_check
from Frontend.StyleSheets import loginStyleSheet, titleStyleSheet, subtitleStyleSheet, generalError
...
class LoginForm(QDialog):
    ...
    def user_login(self):
        ...
        if row is None:
            ...
            print('Hello Jacob, put the spork away!')
    ...
    def submit_profile(self):
        if self.ui.lineEditPassword.text() != self.ui.lineEditConfirmPassword.text():
            ...
            self.appearance("NewError")
        elif check_characters(self.ui.lineEditPassword.text(), "login") is False:
