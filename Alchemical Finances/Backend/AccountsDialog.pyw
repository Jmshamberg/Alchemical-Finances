...
from Frontend.AccountsDialogUi import Ui_Dialog
from Backend.Question import ATypeQuestion
from Backend.UPK import check_characters, modify_for_sql, find_character, first_character_check, decimal_places,\
    switch_sql_tables, directory_pathway
from Frontend.StyleSheets import UniversalStyleSheet, generalError
...
class Accounts(QDialog):
    ...
    def submit_account(self):
        ...
        if accountName == "" or accountOwner == "" or accountBank == "":
            ...
            self.ui.labelError.setStyleSheet(generalError)
            self.ui.lineEditAccount.setStyleSheet(generalError)
        elif check_characters(accountName, "general") is False:
            self.ui.labelError.setText("Alphanumeric Characters only")
            self.setStyleSheet(UniversalStyleSheet)
            self.ui.labelError.setStyleSheet(generalError)
            self.ui.lineEditAccount.setStyleSheet(generalError)
        elif check_characters(accountSubType, "general") is False:
            self.ui.labelError.setText("Alphanumeric Characters only")
            self.setStyleSheet(UniversalStyleSheet)
            self.ui.labelError.setStyleSheet(generalError)
        elif check_characters(accountOwner, "general") is False:
            self.ui.labelError.setText("Alphanumeric Characters only")
            self.setStyleSheet(UniversalStyleSheet)
            self.ui.labelError.setStyleSheet(generalError)
            self.ui.lineEditPrimary.setStyleSheet(generalError)
        elif check_characters(accountBank, "general") is False:
            self.ui.labelError.setText("Alphanumeric Characters only")
            self.setStyleSheet(UniversalStyleSheet)
            self.ui.labelError.setStyleSheet(generalError)
            self.ui.lineEditBank.setStyleSheet(generalError)
            ...
            self.ui.labelError.setStyleSheet(generalError)
            self.ui.lineEditAccount.setStyleSheet(generalError)
        elif check_characters(accountVariable1, "monetary") is False:
            self.ui.labelError.setText("Alphanumeric Characters only")
            self.setStyleSheet(UniversalStyleSheet)
            self.ui.labelError.setStyle(generalError)
            self.ui.lineEditVariable1(generalError)
        elif "," in str(accountVariable2):
            self.ui.labelError.setText("No comma's necessary")
        elif check_characters(accountVariable2, "monetary") is False:
            self.ui.labelError.setText("Alphanumeric Characters only")
            self.setStyleSheet(UniversalStyleSheet)
            self.ui.labelError.setStyle(generalError)
            self.ui.lineEditVariable2(generalError)
        else:
    ...
    def submit_edit(self):
        ...
        if accountName == "" or accountOwner == "" or accountBank == "":
            ...
            self.setStyleSheet(UniversalStyleSheet)
            self.ui.lineEditBank.setStyleSheet(generalError)
        elif check_characters(accountVariable1, "general") is False:
            self.ui.labelError.setText("Alphanumeric Characters only")
            self.setStyleSheet(UniversalStyleSheet)
            self.ui.lineEditVariable1.setStyleSheet(generalError)
        elif "," in str(accountVariable2):
