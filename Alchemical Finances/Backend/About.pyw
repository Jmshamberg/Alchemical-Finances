...
from Frontend.AboutUi import Ui_Dialog
from Frontend.StyleSheets import UniversalStyleSheet, aboutFrame
...
Developed By:          Beaker Labs llc. [Coming Soon? Different Name?]""")
        self.ui.labelDeveloper.setFont(aboutFont)
...
Support:                  Out of Order""")
        self.ui.labelSupport.setFont(aboutFont)
        self.ui.labelSupport.setAlignment(QtCore.Qt.AlignVCenter|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
...
""")
        self.ui.labelDescription.setFont(aboutFont)
        self.ui.labelDescription.setAlignment(QtCore.Qt.AlignVCenter|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
