...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMaximumSize(QtCore.QSize(9999, 401))
        self.labelWelcome = QtWidgets.QLabel(Dialog)
        self.labelWelcome.setGeometry(QtCore.QRect(40, 10, 351, 40))
        font = QtGui.QFont()
        ...
        self.frame.setGeometry(QtCore.QRect(20, 60, 390, 290))
        ...
        self.labelMessage.setGeometry(QtCore.QRect(10, 10, 371, 220))
        ...
        self.labelSigniture.setGeometry(QtCore.QRect(100, 190, 281, 90))
        ...
        self.labelReminder.setGeometry(QtCore.QRect(10, 230, 371, 50))
        ...
        self.pushButtonClose.setGeometry(QtCore.QRect(310, 355, 100, 30))
        self.pushButtonClose.setObjectName("pushButtonClose")
        self.pushButtonNext = QtWidgets.QPushButton(Dialog)
        self.pushButtonNext.setGeometry(QtCore.QRect(210, 355, 100, 30))
